...
byte* microLinnAnchorNote = (byte*)Device.audienceMessages + 31 * microLinnMsg + microLinnMsgLength + 3;
...
//byte *microLinnAnchorCents2    = &Device.audienceMessages + 31 * microLinnMsg + 4;
